...
Static support, privacy, and license pages for the Lumina mobile app. No build
step and no dependencies: three HTML files, one logo, and inline CSS/JS.
...
| `privacy.html` | Privacy policy (PT / EN / ES, LGPD/GDPR language) |
| `license.html` | End User License Agreement, including IAP terms |
| `app_icon.png` | Circular app logo used in the header |

Each page links the other two in the footer. Contact on all three pages is
